...
// Fri Aug  1 17:26:04 2014 by ROOT version 5.34/19
// from TTree MuonD3PD/MuonD3PD
// found on file: /usatlas/u/tbales/scratch/user.tbalestr.PowhegPythia8_AU2CT10.D3PD.2014.08.01.v02.Wplusmunu.pp.1.140801042111/user.tbalestr.028403._00028.skimmed.root
//////////////////////////////////////////////////////////
...
public :
   ...
   vector<float>   *mu_rec_truth_E;
   vector<float>   *mu_rec_truth_dr;
   vector<float>   *mu_rec_truth_eta;
   vector<float>   *mu_rec_truth_phi;
   vector<float>   *mu_rec_truth_pt;
   ...
   vector<int>     *mu_rec_truth_matched;
   vector<int>     *mu_rec_truth_mother_pdg;
   vector<int>     *mu_rec_truth_pdg;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/usatlas/u/tbales/scratch/user.tbalestr.PowhegPythia8_AU2CT10.D3PD.2014.08.01.v02.Wplusmunu.pp.1.140801042111/user.tbalestr.028403._00028.skimmed.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/usatlas/u/tbales/scratch/user.tbalestr.PowhegPythia8_AU2CT10.D3PD.2014.08.01.v02.Wplusmunu.pp.1.140801042111/user.tbalestr.028403._00028.skimmed.root");
      }
