#include "GoodLumiEvent.h"
int GoodLumiEvent::isGoodEvent()
{
	switch(run)
	{
...
int GoodLumiEvent::isGoodBCID_8(int bcid)
{
	switch(bcid)
	{
		case 1:
...
int GoodLumiEvent::isGoodBCID_72(int bcid)
{
	switch(bcid)
	{
		case 1:
...
int GoodLumiEvent::isGoodBCID_206(int bcid)
{
	switch(bcid)
	{
		case 1:
...
int GoodLumiEvent::isGoodBCID_296(int bcid)
{
	switch(bcid)
	{
		case 1:
...
int GoodLumiEvent::isGoodBCID_254(int bcid)
{
	switch(bcid)
	{
		case 1:
...
int GoodLumiEvent::isGoodBCID_144(int bcid)
{
	switch(bcid)
	{
		case 1:
...
int GoodLumiEvent::isGoodBCID_248(int bcid)
{
	switch(bcid)
	{
 		case 1:
